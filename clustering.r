...
####correct batch effect using sample and sequencing time as factor
aGVHD_step_1 <- RunHarmony(aGVHD_step_1, c('batch', 'time'))
...
####correct batch effect using sample and sequencing time as factor
T_NK <- RunHarmony(T_NK, c('batch', 'time'), max.iter.harmony = 10)
...
####correct batch effect using sample and sequencing time as factor
T_NK_2 <- RunHarmony(T_NK_2, c('batch', 'time'), max.iter.harmony = 10)
...
####correct batch effect using sample and sequencing time as factor
CD8_TEM_like <- RunHarmony(CD8_TEM_like, c('batch', 'time'), max.iter.harmony = 10)
...
####correct batch effect using sample and sequencing time as factor
CD8_TEFF_like <- RunHarmony(CD8_TEFF_like, c('batch', 'time'), max.iter.harmony = 10)
...
####correct batch effect using sample and sequencing time as factor
Tcell <- RunHarmony(Tcell, c('batch', 'time'), max.iter.harmony = 10)
